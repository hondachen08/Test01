...
def single_plot():
    try:
        ...
        stock_data = yf.download(stock, start=start_date, end=end_date, progress=False, threads=False, auto_adjust=False)
...
def multi_plot():
    try:
        ...
        stock_data = {ticker: yf.download(ticker, start=start_date, end=end_date, progress=False, threads=False, auto_adjust=False) for ticker in tickers}
